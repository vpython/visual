...
; Make sure help address is correct in vidle/config-main.def
...
Name: numpy; Description: "numpy 1.6.1 {code:NumpyStatus|C:\Python32}"; Types: full; Check: CheckNumpy( 'C:\Python32' )
...
Name: Polygon; Description: "Polygon 3.0a1 {code:PolygonStatus|C:\Python32}"; Types: full; Check: CheckPolygon( 'C:\Python32' )
