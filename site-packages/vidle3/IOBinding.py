...
## The following has been commented out because on Windows
## it places the first line above the edit display, which
## is confusing. It apparently has no effect on Mac or Linux.
##        self.text.see("insert")
    ...
    def save(self, event):
        if not self.filename:
            ...
            if self.file_timestamp != os.stat(self.filename).st_mtime:
                dlg = tkinter.messagebox.Message(
                        master=self.text,
    ...
    defaultextension = '.py' if sys.platform[:3] == 'win' else ''
