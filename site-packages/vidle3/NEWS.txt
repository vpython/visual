What's New in IDLE 3.2?

=======================

*Release date: xx-xx-xx*

merged VIDLE into standard IDLE 3.2
...
absolute address in the use of __import__ in PyShell.py, and the module
names idlelib or vidle in idle.py and idle.pyw, this version can work either
in Python31/Lib/idlelib or in Python31/Lib/site-packages/vidle.

This Python 3 VIDLE is available at vpython.org and will be included in the
Windows and Mac installers for VPython for Python 3.
