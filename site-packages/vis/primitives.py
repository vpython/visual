...
from numpy import array, zeros, arange, int32, float64, sin, cos
from . import crayola
color = crayola
from math import pi
...
class curve (py_renderable_arrayobject, cvisual.curve ):
    ...
    def set_pos(self, positions):
        ...
        try: # A Polygon object (2D), or a simple list of positions
            ...
            cvisual.curve.set_pos(self, array(positions))
            return
...
class text(object):
    ...
    def __init__(self, pos=(0,0,0), axis=(1,0,0), up=(0,1,0), height=1, color=color.white, 
                 x=None, y=None, z=None, red=None, green=None, blue=None,
                 text="", font="TIMES", align='left', visible=True, twosided=True,
...
### Mouse updates are now handled inside graph.py and controls.py
##from .graph import graph_mouse
##from .controls import controls_mouse
##
##def handlemouse():
##    # Process mouse events in graph and controls modules
##    graph_mouse()
##    controls_mouse()
