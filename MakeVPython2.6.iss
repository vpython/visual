...
OutputBaseFilename=VPython-Win-Py2.6-5.70
...
Name: Polygon; Description: "Polygon 2.0.2 {code:PolygonStatus|C:\Python26}"; Types: full; Check: CheckPolygon( 'C:\Python26' )
